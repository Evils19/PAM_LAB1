                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Text("$formattedImc",style: TextStyle(fontSize: MediaQuery.of(context).size.width < 600 ? MediaQuery.of(context).size.width*0.15 : MediaQuery.of(context).size.width* 0.05 ,color:Color(0xFF007BFF)),),
                    ),
                    Container(
                     child:  Text("$raspuns",style: TextStyle(fontSize: MediaQuery.of(context).size.width < 600 ? MediaQuery.of(context).size.width*0.10 : MediaQuery.of(context).size.width* 0.03,color:Color(0xFF007BFF) ),)
                    ),
                    Container(
                      padding: EdgeInsets.only( top:MediaQuery.of(context).size.width < 600 ?50 : 0),
